  ...
  switch (cat) {
    case 'tva-tailwater':
      return [
        ...
        { title: 'Tailwater Dry Hatch Windows', target: 'Trout', when: 'Late spring – early fall during low water', technique: 'Match the hatch: BWO (size 18–20), sulfur (size 16), midge clusters (size 22). Drag-free drift.', where: 'Quiet seams downstream of riffles.', details: 'Dry fly windows on TN tailwaters are short but intense — check generation schedule and time it.' },
      ];
